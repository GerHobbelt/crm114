...
static const char Text1_frag[] =
  {"xxxxx xxxxx xxxxx"
  };
  
static const char Text2_frag[] =
  {"zzzzz zzzzz zzzzz"
  };
...
/*
printf (" Starting to learn the 'Text1' text\n");
  err = crm114_learn_text(&p_db, 0,
			  Text1,
			  strlen (Text1) );

  printf (" Starting to learn the 'Text2' text\n");
...
printf ("\n Classifying the 'Text1' text.\n");
  if ((err = crm114_classify_text(p_db,
				  Text1_frag,
				  strlen (Text1_frag),
				  &result))
      == CRM114_OK)
    { crm114_show_result("Text1 fragment results", &result); }
    else exit (err);

  printf ("\n Classifying the 'Text2' text.\n");
  if ((err = crm114_classify_text(p_db,
				  Text2_frag,
				  strlen (Text2_frag),
				  &result))
      == CRM114_OK)
    { crm114_show_result( "Text2 fragment results", &result); }
    else exit (err);
