...
set urange [-5 : 5]
set vrange [-5 : 5]
set xlabel "Messages" 0,0
set xrange [0 : 1]
set ylabel "(1-ROCA)%  (logit scale) " 0,0
set zlabel "" 0,0
set zrange [-10 : 10]
set autoscale r
set autoscale t
...
# the 1/0 trick is used to plot something (which is NOTHING), so anything that follows is comma-prefixed second!
