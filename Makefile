...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/crm114.lsm.in \
	$(top_srcdir)/configure AUTHORS COPYING ChangeLog INSTALL NEWS \
	TODO m4/config.guess m4/config.sub m4/depcomp m4/install-sh \
	m4/missing
subdir = .
...
ACLOCAL = ${SHELL} /home/ger/prj/3actual/crm114/m4/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
...
AUTOMAKE = ${SHELL} /home/ger/prj/3actual/crm114/m4/missing --run automake-1.9
AWK = gawk
...
PACKAGE_NAME = CRM114
PACKAGE_STRING = CRM114 20040627-BlameSeifkes-auto.1
PACKAGE_TARNAME = crm114
PACKAGE_VERSION = 20040627-BlameSeifkes-auto.1
PATH_SEPARATOR = :
RANLIB = ranlib
SET_MAKE = 
SHELL = /bin/sh
STRIP = 
VERSION = 20040627-BlameSeifkes-auto.1
ac_ct_CC = gcc
am__fastdepCC_FALSE = #
am__fastdepCC_TRUE = 
am__include = include
...
install_sh = /home/ger/prj/3actual/crm114/m4/install-sh
...
crm114.lsm: $(top_builddir)/config.status $(srcdir)/crm114.lsm.in
...
distdir: $(DISTFILES)
	...
	*) \
	...
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/. $(distdir)/examples $(distdir)/m4 $(distdir)/mailfilter $(distdir)/man $(distdir)/tests
...
ChangeLog: NEWS
	/usr/bin/cvs2cl --prune --accum -U ../CVSROOT/users

year.stamp day.stamp month.stamp: ChangeLog configure.ac
	sh ./setversion
...
depend:
	echo "Calculating dependencies for the sources"; 
